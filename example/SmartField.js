...
function replaceOuterHtml(el, html) {
  ...
  if (el.outerHTML) { // If IE
    ...
    el = _foobar(id); // Reassign, since we just overwrote the element in the DOM
  }
  else {
    el.innerHTML = html;
  }
...
var RegexPal = {
  ...
  fields: {
    ...
    options: {
      ...
      highlightSyntax: _foobar("highlightSyntax"),
      highlightMatches: _foobar("highlightMatches"),
      invertMatches: _foobar("invertMatches")
    }
  }
};

function intialize(regexPal) {
  extend(regexPal, function () {
        ...
        return {
          highlightMatches: function () {
            ...
            return function () {
              //console.log("matches inner function");
          ...
          highlightSearchSyntax: function () {
            console.log("highlightSearchSyntax");
